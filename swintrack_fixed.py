#!/usr/bin/env python3
"""
Fixed SwinTrack Object Tracking Script

This version fixes the matplotlib backend compatibility issue on macOS.

Usage:
    python swintrack_fixed.py --input_folder /path/to/images --output_folder /path/to/output --model_path /path/to/model.pth
"""
